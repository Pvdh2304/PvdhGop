...
class Zefoy:
	...
	def __init__(self):
		...
		self.url = 'None'
		self.text = 'AwmxBaby'
		url1=input(" [×_×] Nhập link video tiktok để buff view: ")
		self.url=url1
...
{dac_biet}  
    ...
    {xanh_la} [×_×] Coppyright Pê Vê Đê Hắt 
    \033[1;34m⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦
    {do}[{trang}{kt_code}{do}] {vang}TOOL BUFF VIEW TIKTOK 
    {do}[{trang}{kt_code}{do}] \033[1;35mADMIN:\033[1;36m 🌺 Pê Vê Đê Hắt 🌺
    {do}[{trang}{kt_code}{do}] \033[1;31mZALO ADMIN: \033[1;33m zalo.me/pvdhdeptrai123
    {do}[{trang}{kt_code}{do}] {dac_biet}TELEGRAM ADMIN:\033[1;37m https://t.me/pvdh2304
    {do}[{trang}{kt_code}{do}] {xanh_la}WEB:\033[1;37m https://pvdhdeptrai.vietnamdev.link
    \033[1;34m⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦\n"""
...
while True:
	...
	except Exception as e:print(f'ERROR | Thử Lại Sau 10s.|| {e}');time.sleep(10)
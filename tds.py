from builtins import exec,format,input,len,print,dict,int,range,str,open,exit
exec("")
do="[1;91m"
xanhbien="[1;36m"
vang="[0;33m"
...
banner=Colorate.Horizontal(Colors.green_to_white,f"""
          ...
          @Copyright By Pê Vê Đê Hắt
= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
[•√•] => Admin: Pê Vê Đê Hắt
[•√•] => Telegram: @pvdh2304
[•√•] => Zalo: https://zalo.me/pvdhdeptrai123
...
def idelay(delaymin,delaymax):
	...
	for demtg in range(int(delay),-1,-1):
		print(trang+"["+xanh+"KHANG-TOOL"+trang+"] ["+xanh+"L         "+trang+"] ["+xanh+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+cam+"KHANG-TOOL"+trang+"] ["+cam+"L"+xanh+"O        "+trang+"] ["+cam+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+blue+"KHANG-TOOL"+trang+"] ["+blue+"L"+xanh+"O"+cam+"A       "+trang+"] ["+blue+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+lam+"KHANG-TOOL"+trang+"] ["+lam+"L"+xanh+"O"+cam+"A"+blue+"D      "+trang+"] ["+lam+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+tim+"KHANG-TOOL"+trang+"] ["+tim+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I     "+trang+"] ["+tim+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+xnhac+"KHANG-TOOL"+trang+"] ["+xnhac+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N    "+trang+"] ["+xnhac+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+den+"KHANG-TOOL"+trang+"] ["+den+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G   "+trang+"] ["+den+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+do+"KHANG-TOOL"+trang+"] ["+do+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.  "+trang+"] ["+do+str(demtg)+trang+"]",end="     \r")
		sleep(0.2)
		print(trang+"["+vang+"KHANG-TOOL"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.. "+trang+"] ["+vang+str(demtg)+trang+"]",end="       \r")
		sleep(0.2)
		print(trang+"["+vang+"KHANG-TOOL"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G..."+trang+"] ["+vang+str(demtg)+trang+"]",end="      \r")
...
def NhapTds():
	while True:
		if os.path.exists("Drg-TokenTds.txt"):
			with open("Drg-TokenTds.txt","r")as f:
			...
			if chon=="1":
				...
				os.remove("Drg-TokenTds.txt"); khang(30)
			else:
				print(do+"LỰA CHỌN KHÔNG XÁC ĐỊNH."); khang(30); continue
		if not os.path.exists("Drg-TokenTds.txt"):
			while True:
				khang(30)
				...
				if "error" in login:
					...
					user=login["user"]
					with open("Drg-TokenTds.txt","w")as f:
...
def LuuCookie():
	while True:
		if os.path.exists("Drg-Cookie-Page-Fb-tds.txt"):
			...
			chon=input(edit+"VUI LÒNG NHẬP LỰA CHỌN: "+trang)
			if chon=="1":
				with open("Drg-Cookie-Page-Fb-tds.txt","r")as f:
					list=json.loads(f.read())
					break
			elif chon=="2":
				os.remove("Drg-Cookie-Page-Fb-tds.txt"); khang(30)
			else:
				print(do+"LỰA CHỌN KHÔNG XÁC ĐỊNh."); khang(30); continue
		if not os.path.exists("Drg-Cookie-Page-Fb-tds.txt"):
			list=NhapCookieFb()
	...
	while True:
		...
		for datack in listck["data"]:
			...
			try:
				...
				listck.remove(datack)
				try:os.remove("Drg-Cookie-Page-Fb-tds.txt")
				except:print(end="\r")
main()